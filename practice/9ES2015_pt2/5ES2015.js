...
and returns true if every single value in the array is a finite 
...
a single parameter, an array like object. The function should
return the array like object converted to an array.
...
var obj = new Set([1,2,3,3]);
convertArrayLikeObject(obj);

/*
Write a function called displayEvenArguments which accepts a 
variable number of arguments and returns a new array with all 
of the arguments that are even numbers.
